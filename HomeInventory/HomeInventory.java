...
//com.toedter.calendar.JDateChooser dateDateChooser = new com.toedter.calendar.JDateChooser();
...
static HomeInventory[] myInventory = new HomeInventory[maximumEntries];
int currentEntry;
...
{
myInventory[i] = new HomeInventory();
...
{
 String message = "Any unsaved changes will be lost.\nAre you sure you want to exit?";
 String title = "Exit Program";
if (JOptionPane.showConfirmDialog(null, message, title, JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.NO_OPTION)
  return;
...
private void deleteButtonActionPerformed(ActionEvent e)
{
 ...
 String title = "Delete Inventory Item";
...
{
 String message = "Must have item description.";
 String title = "Error";
...
myInventory[i - 2] = new HomeInventory();
}
}
myInventory[currentEntry - 1] = new  HomeInventory();
...
{
  String title = "Print Error";
JOptionPane.showConfirmDialog(null, ex.getMessage(), title, JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
}
}
}
...
{
myInventory[i - 1] = new HomeInventory();
...
if (edited)
{
  String message = "You have edited this item. Do you want to save the changes?";
  String title = "Save Item";

if (JOptionPane.showConfirmDialog(null, message, title, JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION)
   saveButton.doClick();
}
}
}
