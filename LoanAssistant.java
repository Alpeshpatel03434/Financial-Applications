...
{
  String message = "Invalid or empty Loan Balance entry.\nPlease correct.";
  String title = "Balance Input Error";
...
{
  String message = "Invalid or empty Interest Rate entry.\nPlease correct.";
  String title = "Interest Input Error";
...
{
  String message = "Invalid or empty Number of Payments entry.\nPlease correct.";
  String title = "Number of Payments Input Error";
...
{
  String message = "Minimum payment must be $";
  
if (JOptionPane.showConfirmDialog(null,  message + new DecimalFormat("0.00").format((int)(balance * monthlyInterest + 1.0)) + "\n" + "Do you want to use the minimum payment?", "Input Error", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION)
{
...
{
  String message = "Invalid or empty Monthly Payment entry.\nPlease correct.";
  String title = "Payment Input Error";
...
monthsTextField.setBackground(new Color(101, 101, 101));
...
paymentTextField.setBackground(new Color(101, 101, 101));
